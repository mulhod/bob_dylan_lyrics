...
echo "Created \"dylan_lyrics\" environment successfully! To use " \
     "environment, run \"source activate dylan_lyrics\". To get out of the " \
     "environment, run" \"source deactivate\".\n"
