...
def find_annotation_indices(line: str,
                            annotations: List[str]) -> List[int]:
    """
...
def htmlify_everything(albums: Dict[str, Any],
...
def htmlify_song(name: str,
                 song_id: str,
                 instrumental: bool = False) -> None:
    """
